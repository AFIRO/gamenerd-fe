...
export default function UserListItemComponent(props: User) {
      ...
      return (
        <tr className="align-middle">
          ...
          <td><Link to={`/news/writer/${props.id}`}><button type="button" className="btn btn-secondary m-4">LINK</button></Link></td>
          <td><Link to={`/reviews/writer/${props.id}`}><button type="button" className="btn btn-secondary m-4">LINK</button></Link></td>
